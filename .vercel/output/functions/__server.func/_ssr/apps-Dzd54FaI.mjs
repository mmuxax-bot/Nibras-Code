...
//#region node_modules/.nitro/vite/services/ssr/assets/apps-Dzd54FaI.js
...
var translations = {
	az: {
		...
		arabic_blurb: "Ərəb dili öyrənməsini daha praktik və rahat edən müasir mobil tətbiq. Hərflər, məşq və gündəlik ritm — bir sakit interfeysdə.",
	...
	en: {
		...
		download_android: "Android",
		arabic_blurb: "A modern mobile app that makes learning Arabic more practical and convenient. Letters, practice, and a daily rhythm — in one quiet interface.",
	...
	ar: {
		...
		arabic_blurb: "تطبيق جوال عصري يجعل تعلّم اللغة العربية أكثر عملية وسهولة. الحروف، التمرين، وإيقاع يومي — في واجهة واحدة هادئة.",
	...
	ru: {
		...
		download_android: "Android",
		arabic_blurb: "Современное мобильное приложение, которое делает изучение арабского практичнее и удобнее. Буквы, практика и дневной ритм — в одном тихом интерфейсе.",
...
//#endregion
export { MARQUEE as a, getAppBySlug as c, LANG_META as i, useI18n as l, I18nProvider as n, STUDIO_APPS as o, LANGS as r, cn as s, Button as t };
