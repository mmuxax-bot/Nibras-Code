...
export const Route = createFileRoute("/apps/docs")({
  component: AppPage,
});
      ...
      <section className="app-hero">
        <div className="app-hero-grid" style={{ gridTemplateColumns: "1fr" }}>
          <div className="hero-stagger max-w-2xl">
            <img src="/apps/docs.jpg" alt="Nibras Docs" className="app-icon-lg" />
            ...
            <h1 className="mt-4">
              Nibras
              <span className="hero-accent"> Docs.</span>
            </h1>
        ...
        <Reveal>
          <div className="feat-grid">
            <article className="feat-card">
              <h3>{t("app_docs_f1_t")}</h3>
              <p>{t("app_docs_f1_d")}</p>
            </article>
            <article className="feat-card">
              <h3>{t("app_docs_f2_t")}</h3>
              <p>{t("app_docs_f2_d")}</p>
            </article>
            <article className="feat-card">
              <h3>{t("app_docs_f3_t")}</h3>
              <p>{t("app_docs_f3_d")}</p>
            </article>
          </div>
        </Reveal>
